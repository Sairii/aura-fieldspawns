...
public class EmainRegionScript : RegionScript
{
	...
	public override void LoadSpawns()
	{
		...
		// East (Group 138)
		CreateSpawner(race: 20101, amount: 2, region: 52, coordinates: A(50218,48989, 50218,54416, 55412,54416, 55412,48989));  // Dog
		CreateSpawner(race: 40001, amount: 12, region: 52, coordinates: A(50218,48989, 50218,54416, 55412,54416, 55412,48989));  // Sheep

		// North-East(Group 139)
		CreateSpawner(race: 20101, amount: 4, region: 52, coordinates: A(48673,57698, 48233,66214, 54517,66538, 54957,58022));  // Dog
		CreateSpawner(race: 110002, amount: 22, region: 52, coordinates: A(48673,57698, 48233,66214, 54517,66538, 54957,58022));  // Cow

		// East (Group 140)
		CreateSpawner(race: 40001, amount: 16, region: 52, coordinates: A(47864,54666, 47864,57502, 53825,57502, 53825,54666));  // Sheep
		CreateSpawner(race: 60002, amount: 4, region: 52, coordinates: A(47864,54666, 47864,57502, 53825,57502, 53825,54666));  // Rooster
		CreateSpawner(race: 60003, amount: 24, region: 52, coordinates: A(47864,54666, 47864,57502, 53825,57502, 53825,54666));  // Hen
		CreateSpawner(race: 60004, amount: 10, region: 52, coordinates: A(47864,54666, 47864,57502, 53825,57502, 53825,54666));  // Chick

		// North-West (Group 183)
		CreateSpawner(race: 30014, amount: 20, region: 52, coordinates: A(30288,60895, 30288,65064, 35071,65064, 35071,60895));  // White Spider
	}
}
